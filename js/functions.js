...
(function($) {
  ...
  function about_img() {
    ...
    if (width >= 992) {
      ...
      $(".about-section .about-img img").remove();
      var about_image = $(".about-section .about-img").attr("data-image");
      $(".about-section .about-img").append(
        "<img src='" + about_image + "' />"
      );
    }
  }
  ...
  function trip_img() {
    ...
    if (width >= 992) {
      ...
      var trip_image = $(".trip-detail-section .trip-image-block").attr(
        "data-image"
      );
      $(".trip-detail-section .trip-image-block").css({
        "background-image": "url('" + trip_image + "')",
        height: trip_content_height
      });
    } else {
      $(".trip-detail-section .trip-image-block").removeAttr("style");
      $(".trip-detail-section .trip-image-block img").remove();
